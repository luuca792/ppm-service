...
public class TaskApi {
    ...
    @PutMapping("/{taskId}/material/{materialId}")
    public ResponseEntity<?> updateMaterialToTask(@PathVariable String taskId,
                                               @PathVariable String materialId, @RequestParam Double amount) {
        taskApplication.updateMaterialToTask(UUID.fromString(taskId), UUID.fromString(materialId), amount);
        return new ResponseEntity<>(HttpStatus.CREATED);
    }
