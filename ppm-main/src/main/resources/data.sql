...
INSERT INTO PUBLIC.tasks(id, name, description, duration, start_at, end_at, status, resource_id, project_id)
    VALUES ('96280f9d-151a-45bd-9eea-21eb481bd668', '0', 'Something', 2, NULL, NULL, 'OPEN', NULL, (SELECT id FROM PUBLIC.projects WHERE name = 'Predefined Project'));
INSERT INTO PUBLIC.tasks(id, name, description, duration, start_at, end_at, status, resource_id, project_id)
    VALUES ('da89940f-cc2b-419c-ae91-f3b796f30f34', '1', 'Something', 1, NULL, NULL, 'OPEN', NULL, (SELECT id FROM PUBLIC.projects WHERE name = 'Predefined Project'));
INSERT INTO PUBLIC.tasks(id, name, description, duration, start_at, end_at, status, resource_id, project_id)
    VALUES ('140cb6cc-09a7-4893-bca5-47444314559b', '2', 'Something', 2, NULL, NULL, 'OPEN', NULL, (SELECT id FROM PUBLIC.projects WHERE name = 'Predefined Project'));
INSERT INTO PUBLIC.tasks(id, name, description, duration, start_at, end_at, status, resource_id, project_id)
    VALUES ('010e9fe3-87ac-48d9-8072-808f6cf3b10a', '3', 'Something', 3, NULL, NULL, 'OPEN', NULL, (SELECT id FROM PUBLIC.projects WHERE name = 'Predefined Project'));
INSERT INTO PUBLIC.tasks(id, name, description, duration, start_at, end_at, status, resource_id, project_id)
    VALUES ('43fd7068-a97f-4699-a48d-5670623c5f70', '4', 'Something', 2, NULL, NULL, 'OPEN', NULL, (SELECT id FROM PUBLIC.projects WHERE name = 'Predefined Project'));
INSERT INTO PUBLIC.tasks(id, name, description, duration, start_at, end_at, status, resource_id, project_id)
    VALUES ('b7b19ddd-604a-4f23-bcdb-09bea1b0f1a0', '5', 'Something', 4, NULL, NULL, 'OPEN', NULL, (SELECT id FROM PUBLIC.projects WHERE name = 'Predefined Project'));
INSERT INTO PUBLIC.tasks(id, name, description, duration, start_at, end_at, status, resource_id, project_id)
    VALUES ('bc433a28-3ec1-4e12-8c3d-f6af86902e10', '6', 'Something', 1, NULL, NULL, 'OPEN', NULL, (SELECT id FROM PUBLIC.projects WHERE name = 'Predefined Project'));
INSERT INTO PUBLIC.tasks(id, name, description, duration, start_at, end_at, status, resource_id, project_id)
    VALUES ('09c57873-8423-415c-9696-42e80f50e9bb', '7', 'Something', 2, NULL, NULL, 'OPEN', NULL, (SELECT id FROM PUBLIC.projects WHERE name = 'Predefined Project'));
